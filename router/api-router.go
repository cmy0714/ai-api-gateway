...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/open-payment/notify", controller.OpenPaymentNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/open-payment/pay", middleware.CriticalRateLimit(), controller.RequestOpenPayment)
				selfRoute.GET("/open-payment/status", controller.GetOpenPaymentStatus)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/open-payment/refund", controller.RequestOpenPaymentRefund)
				adminRoute.GET("/open-payment/refunds", controller.GetOpenPaymentRefunds)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/", middleware.CriticalRateLimit(), controller.AddToken)
